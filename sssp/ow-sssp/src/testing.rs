use actions::{main as ow_main, DistanceMessage};
...
/// SSSP distributed testing executable (local Redis, no OpenWhisk)
#[derive(Parser, Debug)]
#[command(version, about, long_about = None)]
struct Args {
    #[arg(long, default_value = "sssp")]
    burst_id: String,
...
fn main() {
    ...
    let actors = proxies
        ...
        .collect::<HashMap<u32, Middleware<DistanceMessage>>>();
